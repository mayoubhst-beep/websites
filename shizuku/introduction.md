...
4. (Pie+) Execute the native program `cmd` ([see here](
5.
6.
7.
8.
9.
10. ))
11. Process the parameters, interact with the system server through the binder, and process the result to output the text result.
